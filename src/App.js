import { Autocomplete, Box, Button, LinearProgress, Paper, Slider, TextField, Typography } from "@mui/material";
    ...
    <Box display='flex' alignItems='center' flexDirection='column' sx={style_scroll}>
      ...
      <Box width="40%" border="1px solid #FF8B03" borderRadius={1} padding={2} bgcolor="#353535" >
        <form onSubmit={formik.handleSubmit}>
          ...
          {!load && !result && <Box overflow="auto" border="1px solid #FF8B03" padding={2} borderRadius={1} sx={style_scroll} display="flex" justifyContent="space-evenly">
          ...
          {!load && !result && <Button color="primary" variant="contained" fullWidth type="submit" sx={{ marginTop: 2, marginBottom: 0, fontWeight: 900, fontSize: 18 }}>
            Preditct
          </Button>}
        </form>
